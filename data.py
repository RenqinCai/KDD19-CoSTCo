...
# from wine_pop import WINE, WINE_TEST
...
class _DATA():
    ...
    def f_load_data_movie(self, args):
        ...
        train_data = MOVIE(args, vocab_obj, train_df, item_boa_dict, user_boa_dict)
        valid_data = MOVIE_TEST(args, vocab_obj, valid_df, item_boa_dict, user_boa_dict)
    ...
    def f_load_data_wine(self, args):
        ...
        # train_data_file = args.data_dir+"/train_debug.pickle"
        train_data_file = args.data_dir+"/train_1.pickle"
        valid_data_file = args.data_dir+"/valid_1.pickle"
        test_data_file = args.data_dir+"/valid_1.pickle"
        ...
        train_data = WINE(args, vocab_obj, train_df)
        valid_data = WINE_TEST(args, vocab_obj, valid_df)
